      ...
      <div class="row-fluid" >
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              <li class="nav-header">作业评分</li>
              <li class="active"  id="index">
            <a href="zuoyepingfen/pgzy.php" target="main">批改作业</a>  </li>
			
              <li ><a href="zuoyepingfen/check.php" target="main">查看分数</a></li>
              
              <li class="nav-header">作业布置</li>
              <li><a href="zuoyebuzhi/zybz.php" target="main">报告布置</a></li>
              
              
                 <li class="nav-header">学生信息管理</li>
              <li><a href="xueshengxinxiguanli/Input.php" target="main">导入学生信息</a></li>
               <li><a href="xueshengxinxiguanli/Output.php" target="main">导出学生信息</a></li>
        ...
        <div class="span9" >
         ...
         <!--在此界面显示跳转的链接，如何用jquery实现，网上看了代码，还是没能成功，求大家指点-->
          <iframe src="zuoyepingfen/pgzy.php" id="iframe" name="main"></iframe>
        </div>      
</div>
</div>
