      ...
      <div class="row-fluid" >
        <div class="span3">
          <div class="well sidebar-nav">
            ...
            <a href="kechengguanli/addkc.php" target="main">增加课程</a>  </li>
			
              <li ><a href="kechengguanli/deletekc.php" target="main">删除课程</a></li>
              
              <li class="nav-header">教师管理</li>
              <li><a href="jiaoshiguanli/addjs.php" target="main">增加教师</a></li>
              <li><a href="jiaoshiguanli/deletejs.html"target="main">删除教师</a></li>
              
              <li class="nav-header">学生管理</li>
              <li><a href="xueshengguanli/addxs.php" target="main">增加学生</a></li>
              <li><a href="xueshengguanli/deletexs.html" target="main">删除学生</a></li>
              
                <li class="nav-header">数据库管理</li>
              <li><a href="http://localhost/phpmyadmin/">进入数据库</a></li>
        ...
        <div class="span9" >
         ...
         <!--在此界面显示跳转的链接，如何用jquery实现，网上看了代码，还是没能成功，求大家指点-->
          <iframe src="kechengguanli/addkc.php" id="iframe" name="main"></iframe>
        </div>      
</div>
</div>
